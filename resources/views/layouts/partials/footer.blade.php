        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    ...
                    <li><a href="{{ url('/lowongan') }}"  class="text-sm text-white/70 hover:text-[#E8001F] transition-colors">Lowongan</a></li>
                    ...
                    <li><a href="{{ url('/kontak') }}"    class="text-sm text-white/70 hover:text-[#E8001F] transition-colors">Kontak</a></li>
                </ul>
            </div>
