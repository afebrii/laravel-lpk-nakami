...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('admin.lowongan.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.lowongan*') ? 'bg-rose-gold/10 text-rose-gold' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
