...
<aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="px-6 py-5 border-b border-white/10">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
            <div class="w-9 h-9 bg-[#C0001E]/20 rounded-lg flex items-center justify-center">
                <span class="text-[#C0001E] font-heading font-bold text-sm">N</span>
            </div>
            <div>
                <p class="font-heading font-bold text-white text-sm">LPK Nakami</p>
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-1">
        ...
        <a href="{{ route('admin.dashboard') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all
                  {{ request()->routeIs('admin.dashboard') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.programs.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.programs*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/></svg>
            Program
        </a>

        <a href="{{ route('admin.lowongan.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.lowongan*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
            Lowongan Kerja
        </a>

        <a href="{{ route('admin.program-categories.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.program-categories*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.registrations.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.registrations*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/></svg>
            Pendaftaran
        </a>

        <a href="{{ route('admin.gallery.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.gallery*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.posts.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.posts*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.testimonials.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.testimonials*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
            <svg class="w-5 h-5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
            Testimoni
        </a>

        <a href="{{ route('admin.faqs.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.faqs*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.services.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.services*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.contacts.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.contacts*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.users.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.users*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
        ...
        <a href="{{ route('admin.settings.index') }}"
           class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all {{ request()->routeIs('admin.settings*') ? 'bg-[#C0001E]/10 text-[#C0001E]' : 'text-white/70 hover:bg-white/5 hover:text-white' }}">
    ...
    <div class="border-t border-white/10 px-4 py-3">
        <div class="flex items-center gap-3">
            <div class="w-8 h-8 bg-[#C0001E]/20 rounded-full flex items-center justify-center shrink-0">
