...
@section('title', 'Layanan — ' . setting('site_name', 'LPK Nakami Indonesia'))
@section('meta_description', 'Lembaga Pelatihan Kerja Nakami Indonesia. Persiapan tenaga kerja profesional untuk program magang dan kerja di Jepang.')
...
{{-- HERO SECTION --}}
{{-- ============================================= --}}
<section class="relative bg-gradient-to-br from-charcoal via-charcoal to-#C0001E-dark overflow-hidden">
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-10 left-10 w-72 h-72 bg-#C0001E rounded-full blur-3xl"></div>
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
        ...
        <div class="flex items-center gap-3 mb-4 mt-4">
            ...
            <span class="text-[#C0001E] text-xs font-bold uppercase tracking-widest">Nakami Indonesia • Layanan</span>
        </div>
        ...
        <p class="text-lg text-white/75 max-w-2xl">
            Lembaga Pelatihan Kerja yang berfokus pada persiapan tenaga kerja profesional untuk penempatan di Jepang.
        </p>
    </div>
</section>
        ...
        <div class="flex justify-center mb-12">
            <div class="inline-flex bg-light-gray rounded-full p-1 gap-1">
                <button @click="activeTab = 'semua'"
                        :class="activeTab === 'semua' ? 'bg-#C0001E text-white shadow-md' : 'text-dark-gray hover:text-charcoal'"
                        class="px-5 py-2 text-sm font-medium rounded-full transition-all duration-300">
                    Semua
                </button>
                @foreach($serviceCategories as $category)
                <button @click="activeTab = '{{ $category->slug }}'"
                        :class="activeTab === '{{ $category->slug }}' ? 'bg-#C0001E text-white shadow-md' : 'text-dark-gray hover:text-charcoal'"
                        class="px-5 py-2 text-sm font-medium rounded-full transition-all duration-300">
                    {{ $category->name }}
                </button>
                @endforeach
        ...
        <div class="space-y-12">
            ...
            <div x-show="activeTab === 'semua' || activeTab === '{{ $category->slug }}'"
                ...
                <div class="flex items-center gap-3 mb-6">
                    <div class="w-12 h-12 bg-#C0001E/10 rounded-xl flex items-center justify-center">
                        <svg class="w-6 h-6 text-#C0001E" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="group bg-white border border-light-gray rounded-2xl p-5 hover:shadow-lg hover:shadow-#C0001E/5 hover:border-#C0001E/20 transition-all duration-300">
                        <div class="flex items-start justify-between gap-4">
                            <div class="flex-1">
                                <h3 class="font-semibold text-charcoal group-hover:text-#C0001E transition-colors mb-1">
                                    {{ $service->name }}
                                </h3>
                            ...
                            <div class="text-right shrink-0">
                                <p class="text-lg font-bold text-#C0001E">{{ $service->formatted_price }}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
...
<section class="py-16 lg:py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <span class="inline-block px-4 py-1.5 bg-#C0001E/10 text-#C0001E text-xs font-semibold rounded-full mb-4 uppercase tracking-wider">Reservasi</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-light-gray rounded-2xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                <div class="w-14 h-14 bg-#C0001E/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <svg class="w-7 h-7 text-#C0001E" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                </div>
                ...
                <a href="https://wa.me/{{ setting('contact_wa_admin') }}?text={{ urlencode('Halo, saya ingin bertanya mengenai program pelatihan di LPK Nakami.') }}"
                   target="_blank"
            ...
            <div class="bg-white border border-light-gray rounded-2xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                <div class="w-14 h-14 bg-#C0001E/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                    <svg class="w-7 h-7 text-#C0001E" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
            ...
            <div class="bg-white border border-light-gray rounded-2xl p-6 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <a href="{{ setting('seo_google_maps_url') }}"
                   target="_blank"
                   class="inline-flex items-center gap-1.5 text-sm font-medium text-#C0001E hover:underline">
                    Buka di Google Maps
...
<section class="py-16 lg:py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-gradient-to-r from-#C0001E to-#C0001E-dark rounded-3xl overflow-hidden px-6 sm:px-12 py-12 lg:py-16 text-center">
            ...
            <div class="relative z-10">
                ...
                <a href="{{ route('program.index') }}"
                   class="inline-flex items-center gap-2 px-7 py-3.5 bg-white text-#C0001E font-semibold rounded-full hover:bg-soft-cream transition-all duration-300 hover:shadow-lg active:scale-95">
