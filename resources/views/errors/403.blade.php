...
@section('title', '403 — Akses Ditolak — ' . setting('site_name', 'LPK Nakami Indonesia'))
...
<section class="py-20 lg:py-32">
    <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="relative mb-8">
            <h1 class="text-[10rem] sm:text-[14rem] font-bold text-rose-gold/10 leading-none select-none">403</h1>
        ...
        <h2 class="font-heading text-2xl sm:text-3xl font-bold text-charcoal mb-3">Akses Ditolak</h2>
        <p class="text-dark-gray mb-8 max-w-sm mx-auto">Maaf, Anda tidak memiliki izin untuk mengakses halaman ini. Jika menurut Anda ini adalah kesalahan, silakan hubungi administrator.</p>
