...
class StoreRegistrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'phone' => ['required', 'string', 'max:20', 'regex:/^62[0-9]{8,15}$/'],
        ...
        if ($this->input('type') === 'pelatihan') {
            $rules = array_merge($rules, [
                ...
                'mother_phone' => ['required', 'string', 'max:20', 'regex:/^62[0-9]{8,15}$/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'mother_phone.required' => 'Nomor HP orang tua/wali wajib diisi.',
            'phone.regex' => 'Nomor WhatsApp harus diawali dengan 62 (contoh: 628...).',
            'mother_phone.regex' => 'Nomor HP orang tua/wali harus diawali dengan 62.',
